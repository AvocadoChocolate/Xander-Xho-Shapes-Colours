...
local function play(part)
    ...
    if part == "bomvu" then
        playPart(18690,1273)
    elseif part == "bhlowu" then
        playPart(4500,1222)
    elseif part == "luhlaza" then
        playPart(7180,1782)
    elseif part == "lubehlo" then
        playPart(13000,1579)
    elseif part == "peple" then
        playPart(21236,1171)
    elseif part == "orenji" then
        playPart(16000,1528)
    end
end
...
local t1 = {text="bhlowu",image="blou.png",sound="vwortel.mp3"}
local t2 = {text="orenji",image="oranje.png",sound="vboontjie.mp3"}
local t3 = {text="bomvu",image="rooi.png",sound="vkomkommer.mp3"}
local t4 = {text="lubehlo",image="geel.png",sound="vuie.mp3"}
local t6 = {text="luhlaza",image="groen.png",sound="vsoetrisse.mp3"}
local t5 = {text="peple",image="pers.png",sound="vspinasie.mp3"}
