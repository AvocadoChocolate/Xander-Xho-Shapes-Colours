...
local speech = {"Kanjalo.", "Unobuchule.", "Kakuhle."}
local dialog = {}
local speechtext = {}
...
function scene:show( event )
    ...
    local speechtext = display.newText( "Ingaba ungayifumana \nimilo efana nale?", speech.x, speech.y,speech.contentWidth/1.3,0,teachersPetFont,20 )
