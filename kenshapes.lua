...
local function play(part)
    print(part)
    if part == "isikwere" then
        playPart(13232,1500)
    elseif part == "unxa ntathu" then
        playPart(6533,1833)
    elseif part == "ntliziyo" then
        playPart(23598,1567)
    elseif part == "isangqa" then
        playPart(3300,1400)
    elseif part == "uxande" then
        playPart(16165,1133)
    elseif part == "inkwenkwezi" then
        playPart(10166,1600)
    end
end
...
local t1 = {text="isikwere",image="vierkant.png",sound="vwortel.mp3"}
local t2 = {text="unxa ntathu",image="driehoek.png",sound="vboontjie.mp3"}
local t3 = {text="ntliziyo",image="hart.png",sound="vkomkommer.mp3"}
local t4 = {text="isangqa",image="sirkel.png",sound="vuie.mp3"}
local t6 = {text="inkwenkwezi",image="ster.png",sound="vsoetrisse.mp3"}
local t5 = {text="uxande",image="reghoek.png",sound="vspinasie.mp3"}
...
function scene:show( event )
    ...
    elseif phase == "did" then        
        ...
        for i=1, #animals do 
        	...
        	local options = {}
        	if animals[i].text == "inkwenkwezi" then
        	        options = 
			{
				--parent = textGroup,
				text = animals[i].text,     
